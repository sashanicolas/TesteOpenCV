...
//  Calibrate
//
//  Created by Sasha Nicolas Da Rocha Pinheiro on 6/5/14.
...
int main(int argc, char* argv[])
{
	...
	cvSave( "intrinsics-my.xml", intrinsic_matrix );
	cvSave( "distortion-my.xml", distortion_coeffs );
    
	// Example of loading these matrices back in
	CvMat *intrinsic = (CvMat*)cvLoad( "intrinsics-my.xml" );
	CvMat *distortion = (CvMat*)cvLoad( "distortion-my.xml" );
